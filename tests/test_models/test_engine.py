...
class TestFileStorageInstatiation(unittest.TestCase):
    """
    Test file storage with no args
    """
    ...
    def test_storage_initializes(self):
        """
        Test if the storage var in models is an instance
        """
...
class TestFileStorage(unittest.TestCase):
    ...
    def test_save_to_file(self):
        ...
        models.storage.new(obj)
        models.storage.save()
        self.assertTrue(os.path.exists(models.storage.test_FileStorage__file_path))
